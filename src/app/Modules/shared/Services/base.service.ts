...
import { HttpErrorResponse } from '@angular/common/http'; // Optional, if you want to show alerts

@Injectable({
    providedIn: 'root',
})
export class BaseService {
    private defaultEndpoint = 'http://localhost:8000/api'; // Set default API endpoint
